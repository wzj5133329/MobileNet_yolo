...
def main(argv):
    ...
    parser.add_argument('-filelist', default = r'/media/xiaosa/xiaosa/学习/深度学习/目标检测/一阶段网络/YOLO/MobileNet-YOLO-master/data/VOC0712/voc_lables.txt',
                        help='path to filelist\n' )
    parser.add_argument('-output_dir', default = r'/media/xiaosa/xiaosa/学习/深度学习/目标检测/一阶段网络/YOLO/MobileNet-YOLO-master/data/VOC0712/', type = str,
    ...
    for line in lines:
        #line = line.replace('resultimages','trainlabels')
    ...
    annotation_dims = np.array(annotation_dims) #保存所有ground truth框的(w,h)(归一化之后的)
